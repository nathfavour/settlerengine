...
- [ ] Configure LiteFS test deployment configuration files.
- [ ] Implement public key derivation (XPUB/ZPUB) address generators in Go.
...
- [ ] Implement write-queue rate-limiters on SQLite to guarantee WAL locks do not exceed 5 seconds.
